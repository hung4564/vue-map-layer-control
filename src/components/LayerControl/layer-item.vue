  ...
  <div class="layer-item-container">
    <div class="layer-item__info">
      <div class="layer-item__icon">
        <div v-if="loading">
          <SvgIcon :size="18" type="mdi" :path="path.loading" class="spin" />
        </div>
        <div v-else>
          <SvgIcon :size="18" type="mdi" :path="path.layer" />
        </div>
      </div>
      <span
      ...
      <div class="layer-item__title-action">
        <div
          ...
          v-bind="menu.attr"
        >
          <SvgIcon :size="16" type="mdi" :path="menu.icon" />
        </div>
        <div
          class="layer-item__button"
          ...
          :disabled="loading"
        >
          <SvgIcon :size="16" type="mdi" :path="path.flyTo" />
        </div>
        <div
          class="layer-item__button"
